...
Nval=[2 4 8 16 32];
save('gaussian_parameters.mat','kencoder','berval','Nval');
...
save(strcat('gaussian_str_k_',num2str(kencoder),'.mat'),'Xnoptall','Ynall','encdistbern','decdistbern','berval','kencoder','Nval');
